...
c.DockerSpawner.image = 'jupyterhub_custom_notebook' # 'jupyter/scipy-notebook'
...
c.DockerSpawner.volumes = { '/var/lib/jupyter-notebooks/jupyterhub-user-{username}': notebook_dir }
